                            ...
                            <form action='' method='POST'>
                                <div class="form-inner">
                                    <div class="input-prepend">
                                        ...
                                        <input class='span4' name='t1' id='username'/>
                                    </div>
                                    <div class="input-prepend">
                                        <span class="add-on"><i class="icon-key"></i></span>
                                        <input type='password' class='span4' name='t2' id='password'/>
                                    </div>
                                ...
                                <footer class="signin-actions">
                                    <input class="btn btn-primary" name="n1" type='submit' id="submit" value='Login'/>
                                </footer>
								<footer class="signin-actions" align="right">
                                 <p style="color:black; align:left;">Don't Have Password ?</p>   <input class="btn btn-primary" type='submit' id="submit" value='Generate M-Pin'/>
                                </footer>
                            </form>
                        </div>
                    </div>
...
if(isset($_GET['n1']))
{
	$user=$_GET['t1'];
	$pswd=$_GET['t2'];
	$query="select * from aadhar_udi where adhar_no='".$user."' and mobile='".$pswd."'";
